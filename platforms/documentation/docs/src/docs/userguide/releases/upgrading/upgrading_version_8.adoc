...
Instead, use the new Isolated Projects safe project identity accessor methods available on `ProjectDependency`:

- link:{javadocPath}/org/gradle/api/artifacts/ProjectDependency.html#getPath()[`ProjectDependency#getPath()`]
- link:{javadocPath}/org/gradle/api/artifacts/ProjectDependency.html#getBuildTreePath()[`ProjectDependency#getBuildTreePath()`]
- link:{javadocPath}/org/gradle/api/artifacts/ProjectDependency.html#getBuildIdentifier()[`ProjectDependency#getBuildIdentifier()`]
